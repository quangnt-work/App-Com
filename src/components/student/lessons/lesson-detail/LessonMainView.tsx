...
import { LessonAudioList } from "./LessonAudioList"; // Component mới tách ra
import { LessonDownloadList } from "./LessonDownloadList"; // Component mới tách ra
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 items-start">
      ...
      <div className="w-full lg:w-1/3 xl:w-4/12 flex flex-col gap-6 sticky top-6">
        {/* Khối Audio */}
        <LessonAudioList lesson={lesson} />
        
        {/* Khối File tải xuống */}
        <LessonDownloadList lesson={lesson} />
      </div>
    </div>
  );
}